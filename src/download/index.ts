...
//   domA.setAttribute('href', 'data:text/plain;charset=utf-8,' + encodeURIComponent(content))
...
// const downloadExcel = (data: { header: any[]; content: any[] }, fileName: string, creator = 'unknown') => {
...
//     downloadBlob(fileName + '.xlsx', new Blob([excelBuffer], { type: 'application/octet-stream' }))
//   } catch (error) {
//     console.error(error)
//     throw error
//   }
...
// const downloadCsv = (data: { header: any[]; content: any[] }, fileName: string, creator = 'unknown') => {
//   const workbook = XLSX.utils.book_new()
...
// export default { downloadTxt, downloadFileFromUrl, downloadBlob, downloadExcel, downloadCsv, downloadJson }
